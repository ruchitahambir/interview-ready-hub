      ...
      <div className="container max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <div className="leading-tight">
            <div className="font-semibold text-foreground">Prep<span className="text-gradient">IQ</span></div>
            <div className="text-[10px] uppercase tracking-wider text-muted-foreground">Recruiter Briefing Tool</div>
          </div>
        </Link>
